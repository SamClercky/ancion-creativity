...
export default class App extends React.Component {
    ...
    private getTestData() {
        return new ShowcaseData([
            ...
            { url: "http://via.placeholder.com/150x275", name: "f2", description: "", keywords: ["mooi", "super"], id: 1 },
            { url: "http://via.placeholder.com/390x200", name: "f3", description: "", keywords: ["lekker", "top"], id: 2 },
            ...
            { url: "http://via.placeholder.com/200x390", name: "f7", description: "", keywords: ["ikweethetniet", "top"], id: 6 }
        ] as IData[])
    }
}